...
public class VectorServico extends JFrame {
	...
	public int adaptadorQtdFornecedor() {
		Servico s;
		int q = 0;
	...
	public int adaptadorQtdCliente() {
		Servico s;
		int q = 0;
		for (int i = 0; i < v.size(); i++) {
			s = (Servico) v.elementAt(i);
	...
	public int adaptadorQtdFuncionario() {
		Servico s;
		int q = 0;
		for (int i = 0; i < v.size(); i++) {
			s = (Servico) v.elementAt(i);
	...
	public void adapClienteMaisPagou() {
		double maiorValor = calc.clienteMaisPagou(v);
	}
}